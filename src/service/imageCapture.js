/* eslint-disable consistent-return,class-methods-use-this,no-unused-vars */
/**
...
let _ImageCapture = window.ImageCapture;

if (typeof _ImageCapture === 'undefined') {
  _ImageCapture = class {
    /**
...
export default {
  create: mediaStreamTrack => new _ImageCapture(mediaStreamTrack),
};
